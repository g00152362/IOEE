...
public class TbGatewayInfo {
    ...
    private Integer lastRebootType;
    ...
    public Integer getLastRebootType() {
        return lastRebootType;
    }

    public void setLastRebootType(Integer lastRebootType) {
        this.lastRebootType = lastRebootType;
    }
